...
const OrderConfirmation = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                const addressResponse = await axios.get('http://localhost:3000/api/v2/user/addresses', {
                    params: { email: email },
                });
                ...
                const cartResponse = await axios.get('http://localhost:3000/api/v2/product/cartproducts', {
                    params: { email: email },
                });
    ...
    const handlePlaceOrder = async (paymentType = 'cod', paypalOrderData = null) => {
        try {
            ...
            const response = await axios.post('http://localhost:3000/api/v2/orders/place-order', payload);
                        ...
                        {paymentMethod === 'paypal' && (
                             <div className='mt-4' style={{ maxWidth: '500px' }}>
                                 <PayPalScriptProvider
                                     options={{
                                         'client-id': 'AYYsIWyLBm84kp0ff7D2rebSJo8E6UXrA9PM-rFi2S7U8Uv3RtkN30pI29fNfBguH632U5byedUIkXXE', 
                                     }}
                                 >
                                     <PayPalButtons
